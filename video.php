...
<link rel="stylesheet" type="text/css" href="styles/services_responsive.css">
	<title>Daftar Video - GIDi</title>
</head>

	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="img/gambar/efata.jpeg"  data-speed="0.8"></div>
		<div class="home_container">
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title"><span>VIDEO</span> GIDI</div>
